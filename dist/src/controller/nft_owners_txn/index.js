...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.nft_owners_txn.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.nft_owners_txn.findUnique({
            where: {
                nft_owners_txn_id: parseInt(id),
            },
        });
        /// SENDING RESPONSE
        return res.json(response_1.default.success(data, "NFT CREATORS MASTER"));
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_owners_txn.create({
            data: body,
        });
        /// SENDING RESPONSE
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_owners_txn.update({
            where: {
                nft_owners_txn_id: parseInt(id),
            },
            data: body,
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_owners_txn.delete({
            where: {
                nft_owners_txn_id: id,
            },
        });
        /// SENDING RESPONSE
