...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.wallet_holdings_master.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.wallet_holdings_master.findFirst({
            where: {
                wallet_address: id.toString(),
            },
        });
        /// SENDING RESPONSE
        return res.json(response_1.default.success(data, "NFT CREATORS MASTER"));
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_master.create({
            data: body,
        });
        /// SENDING RESPONSE
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_master.updateMany({
            where: {
                wallet_address: id.toString(),
            },
            data: body,
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_master.deleteMany({
            where: {
                wallet_address: id.toString(),
            },
        });
