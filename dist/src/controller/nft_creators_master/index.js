...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.nft_creators_master.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.nft_creators_master.findUnique({
            where: {
                nft_collector_id: parseInt(id),
            },
        });
        /// SENDING RESPONSE
        return res.json(response_1.default.success(data, "NFT CREATORS MASTER"));
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    if (!body.address || !body.mint_address || !body.nft_id) {
        return res.json(response_1.default.error("BODY NOT FOUND", "NFT CREATORS MASTER"));
    }
    try {
        const data = yield prisma.nft_creators_master.create({
            data: body,
        });
        /// SENDING RESPONSE
        ...
        console.error(e, "ERROR");
        return res.json(response_1.default.error(e, "INSERT NFT CREATORS MASTER"));
    }
});
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_creators_master.update({
            where: {
                nft_collector_id: parseInt(id),
            },
            data: body,
        ...
        console.error(e, "ERROR");
        return res.json(response_1.default.error(e, "UPDATE NFT CREATORS MASTER"));
    }
});
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_creators_master.delete({
            where: {
                nft_collector_id: id,
            },
        });
        ...
        console.error(e, "ERROR");
        return res.json(response_1.default.error(e, "DELETE NFT CREATORS MASTER"));
    }
});
