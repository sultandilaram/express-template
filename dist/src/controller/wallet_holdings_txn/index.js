...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.wallet_holdings_txn.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.wallet_holdings_txn.findUnique({
            where: {
                wallet_holdings_id: parseInt(id),
            },
        });
        /// SENDING RESPONSE
        return res.json(response_1.default.success(data, "NFT CREATORS MASTER"));
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_txn.create({
            data: body,
        });
        /// SENDING RESPONSE
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_txn.update({
            where: {
                wallet_holdings_id: parseInt(id),
            },
            data: body,
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.wallet_holdings_txn.delete({
            where: {
                wallet_holdings_id: id,
            },
        });
        /// SENDING RESPONSE
