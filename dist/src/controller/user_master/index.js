...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.user_master.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.user_master.findUnique({
            where: {
                user_id: parseInt(id),
            },
        });
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (data) {
            yield prisma.wallet_master.create({
                data: {
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.user_master.update({
            where: {
                user_id: parseInt(id),
            },
            data: body,
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.user_master.delete({
            where: {
                user_id: id,
            },
        });
