...
const get_all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield prisma.nft_trait_master.findMany();
        /// SENDING RESPONSE
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const data = prisma.nft_trait_master.findUnique({
            where: {
                nft_trait_id: parseInt(id),
            },
        });
        /// SENDING RESPONSE
        return res.json(response_1.default.success(data, "NFT CREATORS MASTER"));
...
const insert = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_trait_master.create({
            data: body,
        });
        /// SENDING RESPONSE
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_trait_master.update({
            where: {
                nft_trait_id: parseInt(id),
            },
            data: body,
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield prisma.nft_trait_master.delete({
            where: {
                nft_trait_id: id,
            },
        });
